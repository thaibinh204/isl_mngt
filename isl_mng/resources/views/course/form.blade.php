<div class="box box-info padding-1">
    <div class="box-body">
        ...
        <div class="form-group">
            {{ Form::label('estimate') }}
            {{ Form::text('estimate', $course->estimate, ['class' => 'form-control' . ($errors->has('estimate') ? ' is-invalid' : ''), 'placeholder' => 'Estimate']) }}
            {!! $errors->first('estimate', '<div class="invalid-feedback">:message</p>') !!}
        </div>
        <div class="form-group">
